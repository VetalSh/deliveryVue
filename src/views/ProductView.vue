      ...
      <div class="products-wrapper" id="products-container">
        <div class="products-card">
          <div class="products-card__image">
            <img src="../assets/img/good-1.jpg" alt="goods-1" />
          </div>
            ...
            <div class="products-card__description-row">
              <div class="products-card__description-controls">
                <button class="btn btn-primary">
                  <span>В корзину</span>
                  <img src="../assets/img/icons/cart-white.svg" alt="cart" />
                </button>
        ...
        <div class="products-card">
          <div class="products-card__image">
            <img src="../assets/img/good-2.jpg" alt="good-2" />
          </div>
          <div class="products-card__description">
            <div class="products-card__description-row">
              <h5 class="products-card__description--name">
        ...
        <div class="products-card">
          <div class="products-card__image">
            <img src="../assets/img/good-3.jpg" alt="good-3" />
          </div>
          <div class="products-card__description">
            <div class="products-card__description-row">
        ...
        <div class="products-card">
          <div class="products-card__image">
            <img src="../assets/img/good-4.jpg" alt="good-4" />
          </div>
          <div class="products-card__description">
            <div class="products-card__description-row">
        ...
        <div class="products-card">
          <div class="products-card__image">
            <img src="../assets/img/good-5.jpg" alt="good-5" />
          </div>
          <div class="products-card__description">
            <div class="products-card__description-row">
              <h5 class="products-card__description--name">
        ...
        <div class="products-card">
          <div class="products-card__image">
            <img src="../assets/img/good-6.jpg" alt="good-6" />
          </div>
          <div class="products-card__description">
            <div class="products-card__description-row">
              <h5 class="products-card__description--name">
